...
<!-- INDEX:START (auto-generated by orch-index-decisions — do not edit) -->
## Index

**26 entries** | DECISION: 11 · FIX: 7 · DONE: 3 · AHA: 5

### DECISION (11)
- **L44**: Red Team strategic review: "Run a limited validation test" verdict (2026-08-12)
- **L52**: MSP pivot identified as highest-probability alternative to direct-to-SMB (2026-08-12)
- **L60**: Domain smbcyberhub.com should NOT be pivoted to non-cybersecurity topics (2026-08-12)
- **L86**: Site-wide accuracy remediation following external audit (2026-08-07)
- **L94**: Second-pass remediation after fresh live-site re-audit (2026-08-07, SESSION-003)
- **L170**: Add blog content URLs to LLM files (2026-06-26)
- **L178**: Add HowTo schema to template blog posts (2026-06-26)
- **L186**: Homepage hero: add value summary cards (2026-06-26)
- **L194**: Free training page: show kit contents before download button (2026-06-26)
- **L201**: Content refresh strategy for "Crawled - not indexed" GSC status (2026-07-20)
- **L216**: Remove obsolete tag consolidation redirects (2026-07-20)

### FIX (7)
- **L114**: GDPR Article 39.1(b) overstatement across site (2026-08-07)
- **L122**: Recycled statistics removed from 6 files (2026-08-07)
- **L130**: Industry page categorical claims softened (2026-08-07)
- **L138**: PDF/editable template contradiction (P0) (2026-08-07)
- **L146**: Competitor pricing removed (P0) (2026-08-07)
- **L154**: ISO 27001 references updated to 2022 standard (P1) (2026-08-07)
- **L162**: NIST CSF 2.0 function count corrected (P1) (2026-08-07)

### DONE (3)
- **L209**: GDPR breach notification post refresh (SESSION-002) (2026-07-20, SESSION-002)
- **L224**: Remove 270 tag redirects from _redirects (SESSION-002) (2026-07-20, SESSION-002)
- **L231**: Purge personal email and machine hostname from git history (SESSION-002) (2026-07-20, SESSION-002)

### AHA (5)
- **L68**: Organic SEO alone cannot reach €10k/year at current authority levels (2026-08-12)
- **L74**: Skills-to-market mismatch: enterprise IT skills don't serve SMB buyers (2026-08-12)
- **L80**: Domain authority is topic-specific and does not transfer across niches (2026-08-12)
- **L102**: GDPR Article 39.1(b) is NOT a universal training requirement (2026-08-07)
- **L108**: Recycled cybersecurity statistics have no primary sources (2026-08-07)

<!-- INDEX:END -->

### DECISION -- Red Team strategic review: "Run a limited validation test" verdict
- **Date:** 2026-08-12
- **Context:** Owner commissioned comprehensive Red Team business strategy review using 6-month GSC data (Feb–Aug 2026), AI feature impressions, and full product/pricing analysis. Two independent LLM assessments performed. Goal: determine highest-probability path to €10k/year passive income from SMBCyberHub.
- **Options considered:** (1) Strongly continue current strategy, (2) Continue with material changes, (3) Run limited validation test, (4) Pivot, (5) Abandon
- **Chosen:** (3) Run a limited validation test
- **Rationale:** The data foundation is too thin to justify significant investment — ~35 organic clicks over 6 months, no Gumroad sales data presented, zero evidence of willingness-to-pay. However, the asset exists, the niche has genuine regulatory-driven demand, and the hypothesis (policy/evidence positioning) is reasonable enough to test cheaply. A $150 Google Ads test + marketplace listing can validate demand within 30 days before committing to product development.
- **Trade-offs:** Delays full product build. But building a $129–$169 product without demand validation risks weeks of wasted effort on something nobody may buy.

### DECISION -- MSP pivot identified as highest-probability alternative to direct-to-SMB
- **Date:** 2026-08-12
- **Context:** Owner asked about pivoting the site to a non-cybersecurity IT niche (SAN storage, end-to-end testing) to avoid YMYL ranking strictness. Red Team analysis challenged this: owner's enterprise skills (SAN, testing) don't map to SMB buyers. SMBs don't run SANs or have QA processes. A different buyer — MSPs (Managed Service Providers) — would better leverage all of the owner's skills.
- **Options considered:** (1) Pivot smbcyberhub.com to SAN storage/testing for SMBs, (2) Create new MSP-focused product/site, (3) Stay direct-to-SMB cybersecurity with better distribution, (4) Abandon and monetise credentials via Udemy/course platforms
- **Chosen:** (2) as contingency if (3) fails validation — MSP documentation pack on a separate domain
- **Rationale:** MSPs serve hundreds of SMB clients, need documentation for all of them, understand value of templates, and would pay $199–$299 for a professional pack. This leverages existing cybersecurity content AND owner's infrastructure/storage skills. Less YMYL-sensitive. B2B distribution channels (r/msp, MSP forums) are more targeted than competing for generic Google rankings.
- **Trade-offs:** MSP market is smaller but more concentrated. Requires understanding MSP-specific needs vs direct SMB needs. However, 10–20 MSP licenses at $500/year = €10k/year target achieved with far fewer individual sales.

### DECISION -- Domain smbcyberhub.com should NOT be pivoted to non-cybersecurity topics
- **Date:** 2026-08-12
- **Context:** Owner proposed keeping smbcyberhub.com but pivoting content to SAN storage, testing, or other IT areas, reasoning that 12 months of GSC history had value.
- **Options considered:** (1) Pivot existing domain to new topic, (2) Keep domain for cybersecurity + new domain for new topic, (3) Abandon domain entirely
- **Chosen:** (2) Keep smbcyberhub.com for cybersecurity; use a new domain if pursuing non-cybersecurity content
- **Rationale:** Domain name "smbcyberhub" is intrinsically tied to cybersecurity. 12 months of GSC history with ~35 total clicks provides negligible transferable authority. Google's topic-specific trust doesn't transfer across niches. A fresh domain ($12/year) provides equivalent authority without brand confusion. If the MSP pivot is pursued, a purpose-named domain (e.g., mspinfrakit.com or similar) would outperform trying to rebrand smbcyberhub.com.
- **Trade-offs:** Maintaining two domains if both paths are pursued. But the alternative — confusing both Google and visitors with mismatched domain name and content — is worse.

### AHA -- Organic SEO alone cannot reach €10k/year at current authority levels
- **Date:** 2026-08-12
- **Insight:** Revenue modelling shows that even with 10x traffic improvement (optimistic scenario), organic search alone would generate ~$3,400/year — far short of €10k target. The gap is ~1,000x between current click volume and what's needed. This is not a "tweak the funnel" problem — it requires fundamentally different traffic acquisition or distribution channels (marketplaces, paid ads, B2B licensing, email nurture).
- **Context:** 6-month GSC data: ~35 clicks, ~20,000 impressions. Most commercial queries rank at positions 20–50+ where clicks are near zero. Domain authority is the bottleneck, not content quality.
- **Impact:** SEO should continue as a secondary channel but cannot be the primary revenue driver. Marketplace distribution (Etsy, AppSumo), Google Ads testing, and B2B outreach must be pursued in parallel. Every future session should be evaluated against whether it drives sales, not just rankings.

### AHA -- Skills-to-market mismatch: enterprise IT skills don't serve SMB buyers
- **Date:** 2026-08-12
- **Insight:** Owner's strongest technical skills (SAN storage, end-to-end testing) serve enterprise buyers, not SMBs. A 10-person accounting firm doesn't run SANs (they use Dropbox/NAS) and doesn't have QA processes. Cybersecurity was actually the best SMB-addressable niche because regulations (GDPR, insurance requirements) force non-technical SMB owners to care. The best way to leverage enterprise skills for passive income is to target MSPs (who do manage enterprise tech for SMB clients) rather than trying to sell enterprise concepts directly to SMBs.
- **Context:** Owner proposed pivoting to "another type of IT customer, still small business" using SAN storage and testing skills.
- **Impact:** Any non-cybersecurity pivot should target the buyer who actually uses these skills — MSPs and IT consultancies, not SMB end-users. Product positioning, pricing, and distribution all change when the buyer is a professional IT services provider rather than a non-technical business owner.

### AHA -- Domain authority is topic-specific and does not transfer across niches
- **Date:** 2026-08-12
- **Insight:** 12 months of GSC history on smbcyberhub.com does not provide transferable ranking advantage for non-cybersecurity content. Google's trust signals are topic-anchored — a domain known for cybersecurity policy templates gets no ranking benefit for SAN storage guides. A fresh domain at $12/year starts at the same authority level without the brand confusion of a mismatched domain name.
- **Context:** Owner assumed keeping the site was valuable because "GSC knows about it for the last 12 months."
- **Impact:** Domain retention decisions should be based on whether the domain name and existing topical authority align with the intended content. For cybersecurity content, keep smbcyberhub.com. For any other IT niche, start fresh.
