...
excerpt: "A 5-person CPA practice in Austin faced an FTC Safeguards compliance deadline with zero documentation. Here's how they got audit-ready in one afternoon."
featured: false
canonical: "https://smbcyberhub.com/posts/case-study-cpa-firm-ftc-compliance/"
...
Second, her professional association sent a bulletin warning that the FTC was actively enforcing the [Safeguards Rule](/posts/ftc-safeguards-rule-small-business-compliance/) against tax preparers and accountants. The updated rule requires a written information security program, designated qualified individual, risk assessment, employee training, and incident response procedures. Penalties run up to $50,120 per violation.
...
Rachel mapped her compliance gaps against both the [FTC Safeguards Rule requirements](/posts/ftc-safeguards-rule-small-business-compliance/) and her insurance questionnaire. The overlap was significant:

| Requirement | FTC Safeguards | Insurance Questionnaire | Had It? |
|---|---|---|---|
| Written information security policy | Yes | Yes | No |
| Designated qualified individual | Yes | No | No |
| Risk assessment | Yes | Yes | No |
| Employee security training | Yes | Yes | No (informal only) |
| Training completion records | Yes | Yes | No |
| Incident response plan | Yes | Yes | No |
| MFA documentation | Yes | Yes | Yes (enabled, not documented) |
| Data inventory | Yes | No | No |
| Access control procedures | Yes | Yes | No |
| Backup verification | No | Yes | No |
...
She designated herself as the Qualified Individual — a [Safeguards Rule requirement](/posts/ftc-safeguards-rule-small-business-compliance/) that simply means naming one person responsible for the security program. She documented this in the policy header.
...
- [Phishing recognition](/posts/how-phishing-actually-works-a-simple-breakdown-for-small-teams/) — including examples specific to accounting firms (fake IRS notices, spoofed client emails requesting bank detail changes)
- Password hygiene and [MFA basics](/posts/mfa-myths-busted-what-multi-factor-authentication-really-does/)
- [Safe client file sharing](/posts/safe-client-file-sharing-simple-rules/) — critical for a firm that receives tax documents by email daily
...
Rachel customised the [incident response plan template](/posts/incident-response-plan-template-small-business/) with her firm's contact details, notification chain, and the specific steps relevant to a tax preparation firm. She added the IRS identity theft reporting procedures and state attorney general notification requirements.

She completed the risk assessment template, identifying her top risks:
1. Phishing targeting client financial data
2. [Payment fraud via spoofed invoices](/posts/stop-payment-fraud-callback-playbook/)
...
- Access control procedures and [quarterly review schedule](/posts/quarterly-access-reviews-small-team-playbook/)
...
The insurer renewed the policy at the same premium — no increase. Her broker told her that firms without documentation were seeing 15-25% premium hikes that year. For full detail on what insurers now expect, see our [cyber insurance documentation guide](/posts/cybersecurity-documentation-for-insurance-renewals/).
...
Rachel scheduled [quarterly access reviews](/posts/quarterly-access-reviews-small-team-playbook/) using the kit's checklist. Every quarter, she spends 20 minutes reviewing who has access to what, confirming MFA is still enabled, and checking whether any staff changes require policy updates.
...
|---|---|---|---|
| Compliance consultant (quoted) | $8,000-$12,000 | 4-6 weeks | $3,000-$5,000/year retainer |
| SaaS compliance platform | $200-$500/month | 2-4 weeks setup | $2,400-$6,000/year |
| **SMBCyberHub Pro Kit** | **€99 one-time** | **1 afternoon** | **€0** |
...
Rachel's situation is common. Most small accounting practices have reasonable security habits but zero documentation. The [FTC Safeguards Rule](/posts/ftc-safeguards-rule-small-business-compliance/) and insurance underwriters both require evidence, not intentions.
...
- **Industry-specific regulations** — if you handle healthcare client data alongside financial data, [HIPAA requirements](/cybersecurity-compliance-healthcare/) may also apply
...
### FTC & US Compliance
- **[FTC Safeguards Rule: SMB Compliance Guide](/posts/ftc-safeguards-rule-small-business-compliance/)** — Full breakdown of all 9 requirements
- **[US Cyber Insurance Requirements](/posts/us-cyber-insurance-requirements-small-business/)** — What US insurers expect from small businesses
- **[Cybersecurity Compliance for Accountants](/cybersecurity-compliance-accountants/)** — Industry-specific compliance guidance

### Insurance & Documentation
- **[Cyber Insurance Documentation Guide](/posts/cybersecurity-documentation-for-insurance-renewals/)** — Answer every common insurance question
- **[What Insurers Expect: Training Records](/posts/what-insurers-expect-cybersecurity-training-records/)** — How to prove your team is trained
- **[Proof of Training for Insurance](/posts/how-to-provide-proof-of-cybersecurity-training-for-insurance-renewals/)** — Step-by-step documentation guide

### Templates & Checklists
- **[Incident Response Plan Template](/posts/incident-response-plan-template-small-business/)** — Ready-to-customise IRP
